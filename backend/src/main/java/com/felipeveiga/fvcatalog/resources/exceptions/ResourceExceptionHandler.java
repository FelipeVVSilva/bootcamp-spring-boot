package com.felipeveiga.fvcatalog.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataViolationException(DatabaseException e, HttpServletRequest request){
