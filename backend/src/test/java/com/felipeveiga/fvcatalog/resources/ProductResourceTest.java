...
import com.felipeveiga.fvcatalog.services.ProductService;
...
public class ProductResourceTest {
	...
	void setUp() throws Exception{
		...
		Mockito.when(service.update(eq(nonExistingId), any())).thenThrow(ObjectNotFoundException.class);
	...
	@Test
	public void updateShouldThrowObjectNotFoundWhenIdExists() throws Exception {
	...
	@Test
	public void deleteShoudDoNothingWhenIdExists() throws Exception {
	...
	@Test
	public void deleteShouldThrowObjectNotFoundExceptionWhenIdNotExists() throws Exception {
